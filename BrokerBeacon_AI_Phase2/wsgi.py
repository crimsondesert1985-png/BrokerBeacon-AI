...
Registers BrokerBeacon platform extensions and bridges the existing SaaS
platform-owner context into the extension authorization checks.
"""
...
def bridge_platform_owner_context():
    """Expose the canonical SaaS owner flag to platform extensions."""
